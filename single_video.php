...
$sql1="select count(id) from tb_video";//准备sql语句
...
include_once("opensql.php");
$sql="select * from tb_video where id=$id";//准备sql语句
	...
	<div class='inner_content'>
		...
		<div class='row'>
			<div class='span4'>
				...
				<p>$row[4]</p>
				<h4><span>视频资源</span></h4>
				<ul class='fa-ul'>
					<li><i class='fa-li fa fa-globe colour'></i> 音乐：$row[5]</li>
					<li><i class='fa-li fa fa-pencil colour'></i> 其它：$row[6]</li>
				</ul>
				<h4><span>视频分类</span></h4>
				<ul class='fa-ul'>
					<li><i class='fa-li fa fa-laptop colour'></i> $row[7]</li>
					<li><i class='fa-li fa fa-laptop colour'></i> $row[8]</li>
					<li><i class='fa-li fa fa-laptop colour'></i> $row[9]</li>
				</ul>
				<div class='pad30'></div>
				<a href='' class='btn btn-info  btn-medium btn-rounded'>$row[10]</a>
				<a href='' class='btn btn-info  btn-medium btn-rounded'>$row[12]</a>

				<div class='pad45 clear-fix'></div>

				<div class='portfolio-links'>
					<a href='single_video.php?id=$shang'><span class='fa-stack fa-lg'>
						<i class='fa fa-angle-left fa-stack-1x fa-inverse'></i>
						</span></a>
					<a href='single_video.php?id=$next'><span class='fa-stack fa-lg'>
			...
			<div class='span8'>
				<div class='vendor'>
					<video style='height: 600px;' src='video/$row[11]'  controls='controls' ></video>
				</div>
				<div class='pad25'></div>
			</div>
		</div>
...
<div class="strip2">
	<h1>其它相关视频</h1>
	<h3 class="center about_strip">通过这些视频，你能学到更多</h3>
	<div class="container wrapper">
		<div class="inner_content">
			<div class="inner_content col_full">
				<div id="slider_related">
                    <?php
                    include_once("opensql.php");
                    $sql2="select * from tb_video where v_fen='$row[1]'";//准备sql语句
                    ...
                    while ( $row2=mysql_fetch_row($xian2)) {
						...
						<div class='slider-image'>
							<div >
									<video src='video/$row2[11]' style='height: 600px;' controls='controls' ></video>
							</div>
                            <a class='related_link' href='single_video.php?id=$row2[13]'><span class='hue'>$row2[0]</span></a>
						</div>
					</div>";
                    }
                    ?>

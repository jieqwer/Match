...
<div id="banner">
	<div class="container intro_wrapper">
		<div class="inner_content">
			...
			<h1 class="intro">
				在这里我们有一些 <span class="hue">文章 资料 经验分享</span></h1>
		</div>
	</div>
</div>
	...
	<div class="inner_content">
		<div id="options">
			<ul id="filters" class="option-set" data-option-key="filter">
				...
				<li><a href="#filter" data-option-value=".category01">文章</a></li>
				<li><a href="#filter" data-option-value=".category02">资料</a></li>
				<li><a href="#filter" data-option-value=".category03">经验分享</a></li>
			</ul>
			<div class="clear"></div>
		</div>
		<div class="row">
			...
			<div class="projects">
                ...
                $sql="select * from tb_single";//准备sql语句
                ...
                while ( $row=mysql_fetch_row($xian)) {
                    ...
                    echo "<div class='span3 element $row[1] item_description' data-category='category01'>
					$row[2]
					<div class='item_description'>
						<a href='single_portfolio.php?id=$row[12]'><span class='hue'>了解详情</span></a><br/>
						<span>$row[0]</span>
					</div>
				</div>";
                }

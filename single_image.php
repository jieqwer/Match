...
$sql1="select count(i_id) from tb_images";//准备sql语句
...
include_once("opensql.php");
$sql="select * from tb_images where i_id=$id";//准备sql语句
	...
	<div class='inner_content'>
		...
		<div class='row'>
			<div class='span4'>
				...
				<ul class='fa-ul'>
					<li><i class='fa-li fa fa-globe colour'></i> 时间：$row[4]</li>
					<li><i class='fa-li fa fa-pencil colour'></i> 地点：$row[5]</li>
					<li><i class='fa-li fa fa-laptop colour'></i> 参与人：$row[6]</li>
				</ul>
				<div class='pad15'></div>
				<p>$row[7]</p>
				<div class='pad15'></div>
				...
				<div class='portfolio-links'>
					<a href='single_image.php?id=$shang'><span class='fa-stack fa-lg'>
						<i class='fa fa-angle-left fa-stack-1x fa-inverse'></i>
						</span></a>
					<a href='single_image.php?id=$next'><span class='fa-stack fa-lg'>
			...
			<div class='span8 pad15'>
				<div >
					<a href='img/portfolio/$row[9]' data-rel='prettyPhoto'>
						<img src='img/portfolio/$row[9]' alt='' /></a></div>
				<div class='pad25'></div>
			</div>
			<div class='pad25'></div>
		</div>
...
<div class="strip2">
	<h1>相关图片</h1>
	<h3 class="center about_strip">通过这些，你能看到更多好看的图片</h3>
		...
		<div class="inner_content">
			<div class="inner_content col_full">
				<div id="slider_related" >
                    ...
                    <?php
                    include_once("opensql.php");
                    $sql2="select * from tb_images where i_fen='$row[1]'";//准备sql语句
                    $xian2=$mysqldb->select($sql2);
                    while ( $row2=mysql_fetch_row($xian2)) {
                        echo "<div class='slider-item' style='height: auto;'>
                        <div class='slider-image'>
                            <div >
                                <a  href='img/portfolio/$row2[9]' data-rel='prettyPhoto[portfolio1]'>
                                    <img src='img/portfolio/$row2[9]' style='height:200px' alt=''/></a>
                            </div>                     
                            <a class='related_link' href='single_image.php?id=$row2[11]' ><span class='hue'>$row2[0]</span></a><br/>
                        </div>
                    </div>";
                    }
                    ?>

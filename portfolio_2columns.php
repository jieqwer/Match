...
<div id="banner">
	<div class="container intro_wrapper">
		<div class="inner_content">
			...
			<h1 class="intro">
				在这里我们有一些 <span class="hue">比赛视频 </span><span> and </span><span class="hue"> 学习视频</span></h1>
		</div>
	</div>
</div>
	...
	<div class="inner_content">
		<div id="options">
			<ul id="filters" class="option-set" data-option-key="filter">
				...
				<li><a href="#filter" data-option-value=".category01" >比赛视频 </a> </li>
				<li><a href="#filter" data-option-value=".category02">学习视频</a> </li>
		...
		<div class="row">
            ...
            $sql="select * from tb_video";//准备sql语句
            ...
            while ( $row=mysql_fetch_row($xian)) {
                ...
                echo "<div class='span6 element $row[1]'>
					<div>
						<a href='video/$row[11]'>
							<video src='video/$row[11]' style='height: 600px;' controls='controls' ></video>
						</a>
					</div>
					<div class='item_description'>
						<a href='single_video.php?id=$row[13]'><span class='hue'>查看详情</span></a>
						<br>
						$row[0]
					</div>
				</div>";
